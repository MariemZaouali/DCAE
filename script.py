...
if __name__ == '__main__':
	...
	data_set_img=[r"./Dataset/IP/indian_all_fmm.npy",r"./Dataset/IP/test_fisher_indian90.npy",r"./Dataset/PaviaU/paviaU_all_fmm.npy",r"./Dataset/PaviaU/test_fisher_paviaU50.mat"]
